...
int32 WorldSystem::AddEntityToCreationBuffer(Entity* entity) {
	WorldSingleton* world = admin->singletonWorld;
...
int32 WorldSystem::AddAComponentToWorldEntity(Entity* entity, Component* component) {
	WorldSingleton* world = admin->singletonWorld;
	try {
...
int32 WorldSystem::AddComponentsToWorldEntity(Entity* entity, std::vector<Component*> components) {
	WorldSingleton* world = admin->singletonWorld;
	try {
		Entity* e = admin->entities.at(entity->id);
...
bool WorldSystem::RemoveComponentsFromEntity(Entity* entity, std::vector<Component*> components) { //TODO test this
	WorldSingleton* world = admin->singletonWorld;
	try {
