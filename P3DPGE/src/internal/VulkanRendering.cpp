...
//TODO(c,delle) move this function to a general utility file
...
void VulkanRenderAPI::cleanupVulkan() {
...
void VulkanRenderAPI::createLogicalDevice() {
	...
	VkP3DPGE::QueueFamilyIndices indices = findQueueFamilies(physicalDevice);
...
void VulkanRenderAPI::createSwapChain() {
	...
	VkP3DPGE::SwapChainSupportDetails swapChainSupport = querySwapChainSupport(physicalDevice);
...
void VulkanRenderAPI::createGraphicsPipeline() {
	...
	auto bindingDescription = VkP3DPGE::Vertex::getBindingDescription();
	vertexInputInfo.vertexBindingDescriptionCount = 1;
	vertexInputInfo.pVertexBindingDescriptions = &bindingDescription;
	auto attributeDescriptions = VkP3DPGE::Vertex::getAttributeDescriptions();
...
void VulkanRenderAPI::createCommandPool() {
	...
	VkP3DPGE::QueueFamilyIndices queueFamilyIndices = findQueueFamilies(physicalDevice);
...
void VulkanRenderAPI::createColorResources() {
...
void VulkanRenderAPI::createTextureImage(){
...
void VulkanRenderAPI::createIndexBuffer(){
...
void VulkanRenderAPI::createUniformBuffers(){
	...
	VkDeviceSize bufferSize = sizeof(VkP3DPGE::UniformBufferObject);
...
void VulkanRenderAPI::createDescriptorSets(){
	...
	for (size_t i = 0; i < swapChainImages.size(); i++) {
		...
		bufferInfo.offset = 0;
		bufferInfo.range = sizeof(VkP3DPGE::UniformBufferObject);
...
void VulkanRenderAPI::updateUniformBuffer(uint32 currentImage){
	...
	VkP3DPGE::UniformBufferObject ubo{};
...
VkResult VulkanRenderAPI::CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT* pDebugMessenger) {
...
void VulkanRenderAPI::DestroyDebugUtilsMessengerEXT(VkInstance instance, VkDebugUtilsMessengerEXT debugMessenger, const VkAllocationCallbacks* pAllocator) {
...
bool VulkanRenderAPI::isDeviceSuitable(VkPhysicalDevice device) {
	std::cout << "{-}{-}{-} Checking Validation Layer Support {-}{-}{-}" << std::endl;
	VkP3DPGE::QueueFamilyIndices indices = findQueueFamilies(device);
	bool extensionsSupported = checkDeviceExtensionSupport(device);
	bool swapChainAdequate = false;
	if(extensionsSupported) {
		VkP3DPGE::SwapChainSupportDetails swapChainSupport = querySwapChainSupport(device);
...
VkP3DPGE::QueueFamilyIndices VulkanRenderAPI::findQueueFamilies(VkPhysicalDevice device) {
	std::cout << "{-}{-}{-} Finding Queue Families {-}{-}{-}" << std::endl;
	VkP3DPGE::QueueFamilyIndices indices;
...
VkP3DPGE::SwapChainSupportDetails VulkanRenderAPI::querySwapChainSupport(VkPhysicalDevice device) {
	std::cout << "{-}{-}{-} Querying SwapChain Support {-}{-}{-}" << std::endl;
	VkP3DPGE::SwapChainSupportDetails details;
...
VkSampleCountFlagBits VulkanRenderAPI::getMaxUsableSampleCount() {
...
VkImageView VulkanRenderAPI::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32 mipLevels) {
...
uint32 VulkanRenderAPI::findMemoryType(uint32 typeFilter, VkMemoryPropertyFlags properties) {
...
void VulkanRenderAPI::createImage(uint32 width, uint32 height, uint32 mipLevels, VkSampleCountFlagBits numSamples, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) {
...
void VulkanRenderAPI::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32 mipLevels) {
...
void VulkanRenderAPI::copyBufferToImage(VkBuffer buffer, VkImage image, uint32 width, uint32 height) {
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void VulkanRenderAPI::generateMipmaps(VkImage image, VkFormat imageFormat, int32 texWidth, int32 texHeight, uint32 mipLevels) {
...
VkVertexInputBindingDescription VkP3DPGE::Vertex::getBindingDescription() {
...
std::array<VkVertexInputAttributeDescription, 3> VkP3DPGE::Vertex::getAttributeDescriptions() {
