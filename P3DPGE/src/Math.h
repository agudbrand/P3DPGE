...
namespace Math {
	...
	//TODO(+r, sushi, 11/15/2020, Implement Clipping Algorithm, sushi) mesh Javid's clipping algorithm with what we already have set up, also rewatch his video to fix the camera not moving the clipping plane.
